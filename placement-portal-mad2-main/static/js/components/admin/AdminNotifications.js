/**
 * AdminNotifications.js — GET /api/admin/notifications.
 * Straight chronological list, same pattern as CompanyNotifications.js / StudentNotifications.js. The
 ...
 * than making the admin hunt for the filename in the message text.
 * Defines a global `AdminNotifications` component consumed by router.js.
 */
const AdminNotifications = {
  ...
  methods: {
    fetchNotifications: function () {
      ...
      self.loading = true;
      self.error = '';
      return window.api.get('/admin/notifications').then(function (res) {
